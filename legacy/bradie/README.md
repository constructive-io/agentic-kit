...
- Package name: `@agentic-kit/bradie`
- Import statements: `import { Bradie } from '@agentic-kit/bradie';`
- API and functionality

## Migration Notice

The package has been moved to `legacy/bradie/` in the repository structure but maintains full backward compatibility. No code changes are required for existing users.
